...
namespace Agora.Infrastructure.Migrations
{
    ...
    [Migration("20250504104508_DataValidation")]
            ...
            modelBuilder.Entity("Agora.Core.Models.Post", b =>
                {
                    ...
                    b.ToTable("Posts", null, t =>
                        {
                            t.HasCheckConstraint("CK_Post_Price_Range", "Price >= {ValidationRules.Post.PriceMin} AND Price <= {ValidationRules.Post.PriceMax}");
                        });
                });
            ...
            modelBuilder.Entity("Agora.Core.Models.Transaction", b =>
                {
                    ...
                    b.ToTable("Transactions", null, t =>
                        {
                            t.HasCheckConstraint("CK_Transaction_Price_Range", "Price >= {ValidationRules.Transaction.PriceMin} AND Price <= {ValidationRules.Transaction.PriceMax}");
                        });
                });
