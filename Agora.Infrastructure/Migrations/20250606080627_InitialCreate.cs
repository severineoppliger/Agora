        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Post_Price_Range", "Price >= 0 AND Price <= 100000");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transaction_Price_Range", "Price >= 0 AND Price <= 100000");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Une demande d'échange a été initiée par un des deux utilisateurs mais n'est pas encore acceptée par l'autre utilisateur.", false, false, "En attente" },
                    ...
                    { 4L, "La demande d'échange a été annulée par l’initiateur avant acceptation de l'autre partie.", true, false, "Annulée" },
                    { 5L, "Le service n'a pas pu être réalisé, malgré la confirmation de la demande d'échange.", true, false, "Échouée" },
                    { 6L, "Le service a été réalisé et validé par un seul utilisateur, en attente de confirmation de l'autre.", false, false, "Partiellement validée" },
                    { 7L, "Le service a été effectué et validé par les deux partis. Les points sont transférés de l'acheteur au vendeur.", true, true, "Terminée" },
                    { 8L, "Un désaccord a été signalé par l'une des parties concernant le déroulement de la transaction après qu'un accord initial ait été confirmé par les deux participants.", false, false, "En litige" },
                    { 9L, "La résolution du litige s'est soldé par la validation de la transaction.", true, true, "Résolue et acceptée" },
                    { 10L, "La résolution du litige s'est soldé par l'annulation de la transaction.", true, false, "Résolue et annulée" }
                });
